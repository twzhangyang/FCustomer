...
type MissingDependencyException(dependencyName : string) =
    inherit Exception(sprintf "Could not retrieve object of type '%s" dependencyName)
...
type HttpContext with
    ...
    member this.GetHostingEnvionment() =
    ...
    member this.GetFromValue (key : string) =
